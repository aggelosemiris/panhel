...
const AOTH: Chapter[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'aoth-3-1b', number: '3.1', title: 'Έννοια κόστους' },
      { id: 'aoth-3-2b', number: '3.2', title: 'Σταθερό κόστος' },
      { id: 'aoth-3-3b', number: '3.3', title: 'Μεταβλητό κόστος' },
      { id: 'aoth-3-4b', number: '3.4', title: 'Συνολικό κόστος' },
    ],
  },
  {
    id: 'aoth-4',
